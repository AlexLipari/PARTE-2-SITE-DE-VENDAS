...
function operacaoSolicitada() {
    return prompt("qual operação deseja fazer? (1) Cadastro (2) Imformações ID (3) Ordenar pelo ID (4) Ordenar pelo preço (5) Ordenar pela avaliação (6) Atualizar preço (7) Deletar um produto (8) Adicionar ao Carrinho (9) Encerrar")
}
...
function adicionarProdutoCar (nomeParametro,quantidadeParametro){
 var idProduto = buscarNome(nomeParametro) 
 for (var index = 0;index < contadorCarrinho; index++){
    if (idProduto == arrayIdCarrinho[index]){
